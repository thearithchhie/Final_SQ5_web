...
class AppSettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('app_settings')->insert(array (
            ...
            array(
                'id' => 145,
                'key' => 'web_home_section_1',
                'value' => 'slider',
            ),
            array(
                'id' => 146,
                'key' => 'web_home_section_2',
                'value' => 'categories',
            ),
            array(
                'id' => 147,
                'key' => 'web_home_section_3',
                'value' => 'top_markets',
            ),
            array(
                'id' => 148,
                'key' => 'web_home_section_4',
                'value' => 'popular',
            ),
            array(
                'id' => 149,
                'key' => 'web_home_section_5',
                'value' => 'trending_week',
            ),
            array(
                'id' => 150,
                'key' => 'web_home_section_6',
                'value' => 'empty',
            ),
            array(
                'id' => 151,
                'key' => 'web_home_section_7',
                'value' => 'empty',
            ),
            array(
                'id' => 152,
                'key' => 'web_home_section_8',
                'value' => 'empty',
            ),
            array(
                'id' => 153,
                'key' => 'web_home_section_9',
                'value' => 'empty',
            ),
            array(
                'id' => 154,
                'key' => 'web_home_section_10',
                'value' => 'empty',
            ),
            array(
                'id' => 155,
                'key' => 'web_home_section_11',
                'value' => 'empty',
            ),
            array(
                'id' => 156,
                'key' => 'web_home_section_12',
                'value' => 'empty',
            )
        ));
