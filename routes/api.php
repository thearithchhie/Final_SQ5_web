...
Route::get('getlocation','API\GoogleMapAPIController@index');
Route::get('autocomplete','API\GoogleMapAPIController@queryautocomplete');
Route::get('getlatlng','API\GoogleMapAPIController@getlatlng');
